...
private function update_lead_last_contact($lead_id, $datetime) {
    ...
    public function make_call() {
        ...
        $apiKey = '74549b-4c2871a'; // Змініть на ваш ключ
        $secret = 'bf6b84-d66c7d-cf21bb-e4cee3-e4ebbe20'; // Змініть на ваш секретний ключ
    ...
    private function make_binotel_call($phone, $apiKey, $secret) {
        ...
        $internalNumber = '901'; // Змініть на ваш внутрішній номер у Binotel
